...
object Action {
    const val SERVICE = "io.throneproj.throne.SERVICE"
    const val CLOSE = "io.throneproj.throne.CLOSE"
    const val RELOAD = "io.throneproj.throne.RELOAD"

    // const val SWITCH_WAKE_LOCK = "io.throneproj.throne.SWITCH_WAKELOCK"
