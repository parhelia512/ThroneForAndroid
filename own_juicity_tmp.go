...
import (
	...
	// dyhkwong/sing-juicity 宸插仠鏇翠笖涓?quic-go v0.59 涓嶅吋瀹癸紝
	// 鎹㈢敤娲昏穬缁存姢鐨?exclavenetwork fork锛堜笌瀹樻柟 sing-box v1.13.15 渚濊禆鏍戜竴鑷达紝husi 鍚屾锛夈€?	"github.com/exclavenetwork/sing-juicity"
...
func NewOutbound(ctx context.Context, router adapter.Router, logger log.ContextLogger, tag string, options JuicityOutboundOptions) (adapter.Outbound, error) {
	...
	// 瀹樻柟 v1.13 绛惧悕锛歂ewSTDClient(ctx, logger, serverAddress, options)
